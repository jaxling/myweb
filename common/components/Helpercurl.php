 ...
 *  参考 https://github.com/shuber/curl 进行的改造, 注意此文件有两个class Helpercurl 和 CurlResponse
 * <code>
...
class Helpercurl {
    ...
    **/
    function __construct() {
        //此cookie文件建议使用系统临时目录，当前目录没有权限可写入
        ...
        //user_agent 伪造成谷歌换成firefox浏览器或者随机几个常见的
        $default_user_agent = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.85 Safari/537.36';
        $this->user_agent = isset($_SERVER['HTTP_USER_AGENT']) ? $_SERVER['HTTP_USER_AGENT'] : $default_user_agent;
    }
    ...
    **/
    function __construct($response) {
        ...
        foreach ($headers as $header) {
            ...
            $matches && $this->headers[$matches[1]] = $matches[2];
        }
    }
