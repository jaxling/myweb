...
<link rel="stylesheet" href="../../resourse/font-awesome-4.6.3/css/font-awesome.min.css">            <!-- Font awesome -->
<link rel="stylesheet" href="../../resourse/css/bootstrap.min.css">                                  <!-- Bootstrap style -->
<link rel="stylesheet" href="../../resourse/css/hero-slider-style.css">                              <!-- Hero slider style (https://codyhouse.co/gem/hero-slider/) -->
<link rel="stylesheet" href="../../resourse/css/magnific-popup.css">                                 <!-- Magnific popup style (http://dimsemenov.com/plugins/magnific-popup/) -->

<link rel="stylesheet" href="../../resourse/css/templatemo-style.css">                               <!-- Templatemo style -->
					...
					<div class="row">
						...
						<div class="col-xs-12">
							...
							<div class="tm-bg-white-translucent text-xs-left tm-textbox tm-textbox-1-col">
								<p class="tm-text">Flat design used Hero Slider for left and right page transitions. Responsiveness is based on Bootstrap 4 alpha 2. Images are taken from Unsplash. This web template is provided by templatemo for free of charge.</p>
				...
				<div class="container-fluid js-tm-page-content" data-page-no="3">
					...
					<div class="row tm-img-gallery">
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
							<a href="../../resourse/img/tm-img-01.jpg">
								<img src="../../resourse/img/tm-img-01-tn.jpg" alt="Image" class="img-fluid tm-img">
							</a>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
							<a href="../../resourse/img/tm-img-02.jpg">
								<img src="../../resourse/img/tm-img-02-tn.jpg" alt="Image" class="img-fluid tm-img">
							</a>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
							<a href="../../resourse/img/tm-img-03.jpg">
								<img src="../../resourse/img/tm-img-03-tn.jpg" alt="Image" class="img-fluid tm-img">
							</a>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
							<a href="../../resourse/img/tm-img-04.jpg">
								<img src="../../resourse/img/tm-img-04-tn.jpg" alt="Image" class="img-fluid tm-img">
							</a>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
							<a href="../../resourse/img/tm-img-05.jpg">
								<img src="../../resourse/img/tm-img-05-tn.jpg" alt="Image" class="img-fluid tm-img">
							</a>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
							<a href="../../resourse/img/tm-img-06.jpg">
								<img src="../../resourse/img/tm-img-06-tn.jpg" alt="Image" class="img-fluid tm-img">
							</a>
						</div>                                
					</div>
...
<!-- load JS files -->
<script src="../../resourse/js/jquery-1.11.3.min.js"></script>         <!-- jQuery (https://jquery.com/download/) -->
<script src="../../resourse/js/tether.min.js"></script> <!-- Tether for Bootstrap (http://stackoverflow.com/questions/34567939/how-to-fix-the-error-error-bootstrap-tooltips-require-tether-http-github-h) --> 
<script src="../../resourse/js/bootstrap.min.js"></script>             <!-- Bootstrap js (v4-alpha.getbootstrap.com/) -->
<script src="../../resourse/js/hero-slider-main.js"></script>          <!-- Hero slider (https://codyhouse.co/gem/hero-slider/) -->
<script src="../../resourse/js/jquery.magnific-popup.min.js"></script> <!-- Magnific popup (http://dimsemenov.com/plugins/magnific-popup/) -->
